...
public class Player extends Entity {
	...
	private boolean isCollidingWithPlayer() {
		Rectangle player_current = new Rectangle((int)(this.getX()+ maskx,(int)(this.getY()+ maskY()),this.getMaskW(),this.getMaskH());
	...
	public void tick() {
		...
		if(isDamaged) {
			...
			if(shoot) {
				...
				BulletShoot bullet = new BulletShoot(this.getX() + px, this.getY() + py, width, height, null, dx, 0);
	...
	public void render(Graphics g) {
		...
		if(dir == right_dir) {
			...
			if(gun) {
				...
				g.drawImage(Entity.GUN_RIGHT, this.getX()+0 - Camera.x,this.getY() - Camera.y, null);
			}
		}else if(dir == left_dir) {
			g.drawImage(leftPlayer[index], this.getX() - Camera.x, this.getY() - Camera.y,null);
			if(gun) {
				//Desenhar arma para esquerda. 
				g.drawImage(Entity.GUN_LEFT, this.getX()-0 - Camera.x,this.getY() - Camera.y, null);
			}
